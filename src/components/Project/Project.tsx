      ...
      <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://eyekemet.com" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Eye Kemet</h3>
              <p>
              This website is dedicated to a store that sells accessories, prints, and supplies that carry pictures of your eye’s iris.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Satellite Image Segmantation</h3>
              <p>
              This website is designed to a company that provides an artificial intelligence service to Segmant Any Thing In Satellite Images using a deep learning model.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://CAS.com/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>CAS - Calculate And Succed</h3>
              <p>
              This website is dedicated to calculating and solving mathematical equations that require many steps to solve, and it will give you a detailed answer with steps.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
